print('这是一个测运势的小程序~')
#<---------正题--------->
user_answer_validity = False

while not user_answer_validity:
	user_gender = input('请问您的性别是(F/M):')
	if user_gender == 'F':
		print('萌妹子哦~')
		user_answer_validity = True
		user_age = int(input('多大了啊(数字):'))
		if user_age < 18:
			print('清华妥妥的')
		elif user_age < 30:
			print('马上发财')

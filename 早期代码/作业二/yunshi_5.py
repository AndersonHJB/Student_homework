...
if gender=="M":
	print("你将是男人们的骄傲，请接着进行检测")

elif gender=="F":
	print("你将是女人们的骄傲，请接着进行检测")

else:
	print("你将是人妖们的骄傲，请接着进行检测")

age=int(input("请输入您的年龄（请输入整数）"))

if age<=18:
	print("少年不好好学习，竟然来做什么运势检测，到时你会后悔的")

elif age<=50:
	print("你的事业会一帆风顺，你的前途一片光明")

else:
	print("你的身体将会一直很健康，能够长命百岁，寿比南山")	

# 整体来说，思路清晰从输入到输出整体给出的代码清晰。
# 如下几点需要注意的：
# 1.有没有想过用函数来实现呢？使代码更加简洁高效！（不做示例！）
# 3.为代码划分区域；示例在作业一中已写，注意修改哦！
# 目前有修作业，可以参考一下哦，加油！相信自己
import random

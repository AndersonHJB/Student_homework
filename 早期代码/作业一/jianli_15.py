...
print("正在生成您的简历``````")
print("*"*50)
print(name,gender,age,school)

# # 整体来说，思路清晰从输入到输出整体给出的代码清晰，整体逻辑基本实现。
# 但需要如下完善：
...
# 6.简历内容可以更加完善；（不做示例）
# 7.整体的逻辑可以更加清晰明了，减少代码的重复！（本知识点建议毕老师的算法课程，有意私小助教。）其他学员加了while判断，多个while有点冗余。

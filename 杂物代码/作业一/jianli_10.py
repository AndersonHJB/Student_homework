#A=input('请输入您的姓名>')
#B=input("请输入您的性别>")             *用英文作变量名，不要偷懒（自己给自说的？嘿嘿，不错哦！）
#C=input("请输入您的年龄>")



#print("正在生成您的简历。。。。")
#print("************************")     *使用print（'*'*20）(棒棒哒！)



#print("            简历")             *使用\t
#print("年龄:"+A)                      *换个表示方法试一下
#print ("性别："+B)
#print("年龄："+C)
#print("学校："+D)
...
# 5.在print当中，能不掉用函数尽量不调用，为了提升代码运行效率；
print('正在生成您的简历。。。。')
print('*'*30)
print('\n\t\t简历\n')
